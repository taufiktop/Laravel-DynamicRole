        ...
        <div
            v-if="
                ($page.props.flash.error ||
                    ...
                    show
            "
            class="flex items-center justify-between bg-red-200 rounded max-w-3xl"
        >
            <div class="flex items-center">
                <svg
                    class="ml-4 mr-2 flex-shrink-0 w-4 h-4 fill-current text-red-600"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                >
                    <path
                ...
                <div
                    ...
                    class="py-4 text-red-600 text-sm font-medium"
                >
                    {{ $page.props.flash.error }}
                </div>
                <div v-else class="py-4 text-red-600 text-sm font-medium">
            ...
            <button type="button" class="group mr-2 p-2" @click="show = false">
                <svg
                    class="block w-2 h-2 fill-red-800 fill-current text-red-600"
                    xmlns="http://www.w3.org/2000/svg"
                    width="235.908"
                    height="235.908"
                    viewBox="278.046 126.846 235.908 235.908"
