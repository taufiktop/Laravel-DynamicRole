          ...
          >
            ...
            -->
              <li
                ...
                v-bind:key="index"
                class="text-gray-900 select-none relative py-2 pl-3 pr-9 cursor-pointer hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:text-gray-900 focus:bg-gray-100"
                v-bind:class="{
            ...
            -->
              <li
                ...
                class="text-gray-900 select-none relative py-2 pl-3 pr-9 cursor-pointer focus:outline-none focus:text-white focus:bg-indigo-600"
              >
